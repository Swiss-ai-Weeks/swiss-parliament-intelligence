...
export function overviewEvidence(input, collection = []) {
 ...
 if (!/^(summarize the selected (proposal|person)'s available debate passages\.|résume les interventions disponibles pour (cet objet|cette personne)\.|what does the imported record tell us about this topic\?)$/i.test(input.question.trim())) return null;
