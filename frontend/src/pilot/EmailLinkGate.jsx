...
export default function EmailLinkGate({status,rawLink}) {
 ...
 {state==='success'?<div className="account-success-icon"><SealCheck size={64} weight="duotone" aria-label="Sign-in successful"/></div>:<img src={base+'images/cleisthenes.png'} alt="Cleisthenes" width="96" height="96" style={{objectFit:'cover',borderRadius:'50%'}}/>}<p style={{fontFamily:'Georgia,serif',fontSize:24}}>midnight.vote</p>
