...
export default function EmailLinkGate({status,rawLink}) {
 ...
 useEffect(()=>{history.replaceState({},'',location.pathname+'?view=dashboard');if(status==='complete')api.me().then(()=>setState('success')).catch(()=>setState('expired'));},[]);
 ...
 <img src={base+'images/cleisthenes.png'} alt="Cleisthenes" width="96" height="96" style={{objectFit:'cover',borderRadius:'50%'}}/><p style={{fontFamily:'Georgia,serif',fontSize:24}}>midnight.vote</p>
