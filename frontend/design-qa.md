...
- State: Ask active, English active, source 1 selected, video paused, speaker list collapsed to three visible people.

## Full-view comparison evidence

The source and the final browser capture were opened together in one comparison input. The implementation preserves the source's three-column composition, charcoal palette, teal active states, compact top bar, Ask/Investigate hierarchy, question composer, evidence-cited answer, and source/video rail. The added speaker module appears below source metadata, as requested, without displacing the primary answer or video.
